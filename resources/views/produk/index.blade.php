        ...
        <div class="container-fluid">
            <div class="navbar-brand text-dark fw-bold">
                <a href="{{ route('admin.dash') }}">
                    <i class="fa fa-caret-square-left me-2"></i> Produk
                </a>
            </div>
            ...
            @if (request('search'))
                <div class="mb-2">
                    <small class="text-muted">
                        Ditemukan {{ $produk->total() }} produk untuk kata kunci
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="{{ route('produk.show', $item->id) }}"
                                                    class="dropdown-item">Lihat</a></li>
                                            <li><a href="{{ route('produk.edit', $item->id) }}"
                                                    class="dropdown-item">Edit</a></li>
                                            <li><button type="button" class="dropdown-item text-danger"
                                                    onclick="deleteProduk('{{ $item->id }}')">Hapus</button></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
