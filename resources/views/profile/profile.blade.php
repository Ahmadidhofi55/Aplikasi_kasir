        ...
        <div class="page-inner py-4">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4>Edit Profil</h4>
                    <a href="{{ route('profile.show', $user->id) }}" class="btn btn-secondary">← Kembali</a>
                </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="nama_lengkap" name="nama_lengkap"
                                        value="{{ old('nama_lengkap', $user->nama_lengkap) }}" class="form-control">
                                    @error('nama_lengkap')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="type" id="type" class="form-select">
                                        ...
                                        <option value="0" {{ $user->type == 0 ? 'selected' : '' }}>Kasir</option>
                                    </select>
                                    @error('type')
                                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                                    @enderror
