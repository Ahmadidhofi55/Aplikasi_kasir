...
<body>
        ...
        <div class="sidebar" data-background-color="dark">
            <div class="sidebar-logo">
                ...
                <div class="logo-header" data-background-color="dark">
                    ...
                    <a href="{{ route('kasir.dash') }}" class="logo">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="penjualan">
                                <ul class="nav nav-collapse">
                                    <li>
                                        <a href="{{ route('penjualankasir.index') }}">
                                            <span class="sub-item">💵Penjualan</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('transaksi.riwayat.kasir') }}">
    ...
    <script>
        // Chart init (Contoh dummy, sesuaikan dengan data nyata di controller)
